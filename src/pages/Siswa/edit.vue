  <script setup>
    ...
    onMounted( () => {
        axiosClient.get(`/api/siswa/edit/${router.currentRoute.value.params.id}`)
            .then( (response) => {
    ...
    function submit() {
        ...
        axiosClient.post( `/api/siswa/edit/${router.currentRoute.value.params.id}`, formData )
            .then(res => {
                console.log(res);
    ...
    <form @submit.prevent="submit">
      <div class="space-y-12">
        <div class="pb-12 border-b border-gray-900/10">
          <!-- <h2 class="font-semibold text-gray-900 text-base/7">Edit Siswa</h2> -->
