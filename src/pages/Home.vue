    ...
    <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 md:gap-6">
        <div class="rounded-2xl border border-gray-200 bg-white p-5 dark:border-gray-800 dark:bg-white/[0.03] md:p-6" >
            ...
            <div class="flex items-end justify-between mt-5">
                <div>
                    <span class="text-xl text-gray-500 dark:text-gray-400">Program</span>
                    <h4 class="mt-2 font-bold text-gray-800 text-title-sm ">{{ programs }}</h4>
                </div>
        ...
        <div class="rounded-2xl border border-gray-200 bg-white p-5 dark:border-gray-800 dark:bg-white/[0.03] md:p-6" >
            ...
            <div class="flex items-end justify-between mt-5">
                <div>
                    <span class="text-xl text-gray-500 dark:text-gray-400">Siswa</span>
                    <h4 class="mt-2 font-bold text-gray-800 text-title-sm ">{{ siswa }}</h4>
                </div>
...
onMounted( () => {
    axiosClient.get('/api/program-pilihan')
        .then( (response) => {
            ...
            programs.value = response.data.length;
        })
})
...
onMounted( () => {
    axiosClient.get('/api/siswa')
        .then( (response) => {
            // console.log(response.data.length);
            siswa.value = response.data.length;
        })
})
